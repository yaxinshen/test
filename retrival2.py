...
if __name__=='__main__':
    mysql = MysqlOperator()
    #fea_q, id_q = get_fea('/data/data/shenyaxin/fea/color_fea_27_sv_om_1.json')
    #fea_db, id_db = get_fea('/data/data/shenyaxin/fea/color_fea_27_sv_om_0.json')
    ...
    fea_q = np.concatenate((fea_q2, 1.5*fea_q), axis = 1)
    fea_db = np.concatenate((fea_db2, 1.5*fea_db), axis = 1)
